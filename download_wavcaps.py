...
base_url = "https://huggingface.co/datasets/cvssp/WavCaps/resolve/main/Zip_files/AudioSet_SL/"
...
extract_dir = "/fs/cbcb-scratch/milis/data/wavcaps"  # Change this to a valid path in your environment
...
combined_zip_path = os.path.join(download_dir, "AudioSet_SL_combined.zip")
